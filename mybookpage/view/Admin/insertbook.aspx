<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="insertbook.aspx.cs" Inherits="mybookpage.view.Admin.insertbook" %>
    ...
    <form id="form1" runat="server">
      <header>
        ...
        <div class="con">
                ...
                <asp:GridView ID="allbookgrid" runat="server" Caption="Book Details" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="allbookgrid_SelectedIndexChanged" AutoGenerateColumns="False" Width="388px">
